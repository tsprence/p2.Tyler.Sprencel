...
//Calendar variables
var day;
let calendarData, morning, midmorning, evening
var clickedClock, clickedWeather, clickedCalendar, clickedNews, clickedWeight = false;
//Weather variables
let curr_temp, curr_short_forecast, weatherData
//News variables
let newsData, article1, article2, article3, article4, article5, article6
...
function mousePressed() {
    //If the icon is clicked then the widget is opened
    ...
    //If the close icon is clicked then the widget closes
    if(checkIcon(close1)) {
        clickedClock = false
...
//Formatting for correct clock display
